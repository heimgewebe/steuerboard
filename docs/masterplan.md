...
Phase 11F-B adds an artifact-derived contract for the Heimserver-Service-Gate. Runtime execution and runbook kinds remain future-gated. The task documents boundaries and open decisions before any implementation.
